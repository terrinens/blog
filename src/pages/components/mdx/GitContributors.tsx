import {callUserInfos, getOrgContributorsInfo} from "@/pages/lib/github/GithubData";
import {GitUserInfo} from "@/pages/lib/github/GitConfig";
    ...
    return (
        <div
            ...
            <div className="flex items-center gap-x-4">
                <img width={80} height={80} className="rounded-full size-20" src={info.avatarURL} alt="Avatar"/>
                <div className="grow">
