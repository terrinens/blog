...
const dummyInfos = [
    {
        ...
        "avatarURL": "https://avatars.githubusercontent.com/u/132042125?v=4",
        "blog": "https://terrinens.github.io/blog/",
        "publicRepos": 9,
        "bio": "백엔드 개발자 희망"
    },
    {
...
export const gitContributorsComponentDescriptors: JsxComponentDescriptor = {
    ...
    props: [
        ...
        {name: 'repName', type: 'string', required: true},
...
export const InsertGitContributors = () => {
