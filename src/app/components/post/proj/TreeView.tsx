...
export function DefaultFileSVG({width, height}: { width?: number, height?: number }) {
    return (
        <svg className="shrink-0 size-4 text-gray-500"
             xmlns="http://www.w3.org/2000/svg" width={width ?? "24"}
             height={height ?? "24"} viewBox="0 0 24 24" fill="none"
